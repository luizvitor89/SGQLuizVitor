...
using CIP.API.IntegrationEvents.EventHandling;
...
namespace CIP.API
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            //Cria e carregar dados se o banco estiver vazio
            try
            {
                var context = containerBuild.Resolve<CIPContext>();
                context.Database.Migrate();
                new CIPContextSeed().SeedAsync(context).Wait();
            }
            catch
            {
            }

            return new AutofacServiceProvider(containerBuild);
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "CIP API");
        ...
        private void RegisterEventBus(IServiceCollection services)
        {
            ...
            services.AddTransient<CadastroNCIntegrationEventHandler>();
        }
        ...
        private void ConfigureEventBus(IApplicationBuilder app)
        {
            ...
            eventBus.Subscribe<CadastroNCIntegrationEvent, CadastroNCIntegrationEventHandler>();
        }
    }
}
